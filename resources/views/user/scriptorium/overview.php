                ...
                <div class="content">
                    ...
                    <p><?php 
                        foreach(E\User::getUserPublications($protagonist->id) as $pub){
                            ...
                            echo "<a href=\"/crash/users/scriptorium/leaflet?id=$pub->id\"><mark class=\"success\">[new page]</mark></a> <a href=\"#\"><mark class=\"info\">[edit]</mark></a> <a href=\"#\"><mark class=\"danger\">[delete]</mark></a>";
                            echo "<br>";
                        }
                    ?></p>
                    <h4>Tasks</h4>
